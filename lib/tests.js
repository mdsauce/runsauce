...
tests.delayTest504 = async function(driver, url) {
  await driver.get("http://saucelabs.com/test/guinea-pig");
  await driver.waitFor(titleToMatch("I am a page title"), 10000, 1000);
  await sleep(280000); // almost 5 min to wait
  await driver.get("http://ec2-18-237-58-228.us-west-2.compute.amazonaws.com:4567/45000/https://saucelabs.com"); // website takes 45+sec to load
  await driver.waitFor(titleToMatch("Sauce Labs"), 1000, 800);
};

tests.chefTest = async function(driver, url) {
  await sleep(15);
  await driver.get("http://saucelabs.com/test/guinea-pig");
  await driver.waitFor(titleToMatch("I am a page title"), 10000, 1000);
  await driver.get("http://ec2-54-202-224-186.us-west-2.compute.amazonaws.com:4567/45000/https://saucelabs.com"); // website takes 45+sec to load
};
